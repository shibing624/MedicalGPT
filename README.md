...
## 🔥 News
[2025/02/17] v2.4版本：新增GRPO训练方法，GRPO通过纯RL方法可以体验`aha moment`，支持了 **[DeepSeek-V3](https://huggingface.co/deepseek-ai/DeepSeek-V3)** 模型，详见[Release-v2.4](https://github.com/shibing624/MedicalGPT/releases/tag/2.4.0)
